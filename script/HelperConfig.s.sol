...
contract HelperConfig is Script {
    ...
    address public constant AVALANCHE_FUJI_PEER = address(0);
    address public constant AVALANCHE_FUJI_SHARE_TOKEN = 0x550a6bef9fa59639Cd73126D7D066948280f9FB9;
    address public constant AVALANCHE_FUJI_SHARE_POOL = 0x37E3C6AA78cA309Dd43cE99f8Ff74323c627F2cC;

    address public constant ETH_SEPOLIA_PEER = address(0);
    address public constant ETH_SEPOLIA_SHARE_TOKEN = 0x5C5f07FD137Aa38860B5fA2ca5671bd5C49333B4;
    address public constant ETH_SEPOLIA_SHARE_POOL = 0x0d354354220848d60667E41fD7099679d44C6D9A;

    address public constant BASE_SEPOLIA_PEER = address(0);
    address public constant BASE_SEPOLIA_SHARE_TOKEN = 0x771ceed62ac79cBa5Ec557b8095b8Cdc13559dD3;
    address public constant BASE_SEPOLIA_SHARE_POOL = 0xdBfD473bCb5dC3D324716B25BB14776964575122;
    ...
    function getEthSepoliaConfig() public returns (NetworkConfig memory) {
        ...
        remotePeers[0] = AVALANCHE_FUJI_PEER;

        // remoteChainSelectors[0] = BASE_SEPOLIA_CHAIN_SELECTOR;
        remoteChainSelectors[0] = AVALANCHE_FUJI_CHAIN_SELECTOR;

        // remoteSharePools[0] = BASE_SEPOLIA_SHARE_POOL;
        remoteSharePools[0] = AVALANCHE_FUJI_SHARE_POOL;

        // remoteShares[0] = BASE_SEPOLIA_SHARE_TOKEN;
        remoteShares[0] = AVALANCHE_FUJI_SHARE_TOKEN;

        return NetworkConfig({
            ccip: CCIPConfig({
                ccipRouter: 0x0BF3dE8c5D3e8A2B34D2BEeB17ABfCeBaf363A59,
                thisChainSelector: 16015286601757825753,
                parentChainSelector: AVALANCHE_FUJI_CHAIN_SELECTOR,
    ...
    function getAvalancheFujiConfig() public returns (NetworkConfig memory) {
        ...
        return NetworkConfig({
            ...
            peers: PeersConfig({
                localPeer: AVALANCHE_FUJI_PEER, // This is address(0) - will be handled by deploy script
                localChainSelector: AVALANCHE_FUJI_CHAIN_SELECTOR,
                remotePeers: new address[](0),      // Empty - no remote peers yet
                remoteChainSelectors: new uint64[](0), // Empty - consistent with remotePeers
                localSharePool: AVALANCHE_FUJI_SHARE_POOL,
                remoteSharePools: new address[](0), // Empty - consistent with remotePeers
                localShare: AVALANCHE_FUJI_SHARE_TOKEN,
                remoteShares: new address[](0)      // Empty - consistent with remotePeers
            })
        });
    }
}